    ...
    <div class="row align-equal gy-4">
        ...
        <div class="col-lg-6 col-md-6 d-flex">
            <?php if (isset($_SESSION['customer_id'])): ?>
                <form method="post" action="contact_message.php"
                      class="contact-form p-4 border rounded bg-white shadow-sm flex-grow-1 d-flex flex-column">
                    <div class="mb-3">
                    ...
                    <div class="mb-3 flex-grow-1">
                        ...
                        <textarea id="message" name="message" rows="5" class="form-control h-100"
            ...
            <?php else: ?>
                <div
                    class="p-4 border rounded bg-white shadow-sm flex-grow-1 d-flex flex-column justify-content-center text-center">
                    <h5 class="fw-bold mb-3">Want to send us a message?</h5>
                            <p class="mb-3 text-muted">Please <a href="/hardware/login.php" class="fw-bold">log in</a> or <a
          href="/hardware/register.php" class="fw-bold">create an account</a> to contact us.</p>
        ...
        <div class="col-lg-6 col-md-6 d-flex">
            <div class="contact-info bg-white p-4 border rounded shadow-sm flex-grow-1 d-flex flex-column">
                ...
                <p class="mb-2"><i class="bi bi-geo-alt-fill me-2 text-primary"></i> 123 Main Street, Jaffna, Sri
                    Lanka</p>
                ...
                <div class="map-responsive rounded overflow-hidden shadow-sm">
                    <iframe
                        ...
                        title="K.N. Raam Hardware Location"></iframe>
                </div>
            </div>
        </div>
