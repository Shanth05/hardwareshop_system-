...
include('header.php'); // Includes DB connection, navbar, sidebar, etc.
...
// Fetch order details with total_items
$sql = "
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $allowed_statuses = ['ordered', 'processing', 'delivered'];
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <select name="order_status" class="form-select" required>
                        <?php foreach (['ordered','processing','delivered'] as $status): 
